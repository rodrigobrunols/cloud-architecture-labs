...
class CleanPDFBuilder:
    ...
    def build(self, output_path):
        ...
        # Standard Adobe Core 14 Fonts with WinAnsiEncoding (Full Portuguese Accent Support)
...
def draw_circle(cmds, cx, cy, r, r_fill, g_fill, b_fill):
    # Approximating circle via 4 bezier curves (kappa = 0.5522847498)
    k = 0.5522847498 * r
    cmds.append("q")
    cmds.append(f"{r_fill:.3f} {g_fill:.3f} {b_fill:.3f} rg")
...
def draw_slide_base(cmds, page_idx, total_pages=5, swipe_text="Arraste para o lado  ->"):
    # Clean Dark Slate Background (#0B0F19 -> RGB: 0.043, 0.060, 0.098)
    ...
    # Top Accent Glow Bar (Orange AWS)
...
def build_carousel_pdf():
    ...
    # =========================================================================
    # SLIDE 1: CAPA (Impacto Editorial Técnico)
    # =========================================================================
    s1 = []
    ...
    draw_text(s1, "-> Roteamento na Edge com multiplas origens e zero desperdicio.", 115, t_y + 40, font="F2", size=19, r=0.20, g=0.83, b=0.60)
    ...
    # =========================================================================
    # SLIDE 2: O ERRO CLÁSSICO (Container vs S3)
    # =========================================================================
    s2 = []
    ...
    # =========================================================================
    # SLIDE 3: O CONCEITO (O Guarda de Trânsito)
    # =========================================================================
    s3 = []
    ...
    # =========================================================================
    # SLIDE 4: CENÁRIO REAL (E-Commerce)
    # =========================================================================
    s4 = []
    ...
    output_file = "carrossel_cloudfront_behaviors.pdf"
    pdf.build(output_file)
    print(f"Sucesso! PDF compilado com acentuação impecável: {output_file} ({os.path.getsize(output_file)} bytes)")
